...
from bowling import get_score, NotTenThrows
game_results = ['XX1/51X1/-3--41','XX1/51X1/-3--41X', 'XX1/51X1/-3--55X', 'XX1/51X1/-3--5gX']
for result in game_results:
    try:
        get_score(result)
    except(NotTenThrows, ArithmeticError, ValueError) as exp:
        print(f'{exp}')
    print('========================')
